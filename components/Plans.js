    ...
    plans: [
      {
        ...
        subtitle: "Tú pones el contenido, nosotros lo convertimos en ventas. Campañas sin límite en Meta y TikTok.",
        price: "$200",
        popular: false,
        features: [
          "Campañas ilimitadas en Facebook e Instagram",
          "Campañas ilimitadas en TikTok Ads",
          "Optimización diaria de presupuesto y audiencias",
          "Segmentación avanzada por intereses y comportamiento",
          "Reporte mensual con métricas reales y transparentes",
    ...
    plans: [
      {
        tier: "NIVEL 1",
        name: "Plan Básico",
        subtitle: "Ideal para empezar: tú nos envías el material y nosotros hacemos crecer tu negocio en Meta Ads.",
        price: "$130",
        popular: false,
        features: [
          "2 artes estáticos diseñados para convertir",
          "2 videos cortos publicitarios (máx. 45 seg.)",
          "1 carrusel estratégico (hasta 3 imágenes)",
          "Gestión profesional de Instagram y Facebook",
          "2 campañas activas en Meta Ads",
          "Copys publicitarios con enfoque en ventas",
          "Monitoreo y optimización continua 24/7",
          "Reporte mensual de resultados reales",
        ],
      },
      {
        tier: "NIVEL 2A",
        name: "Plan Básico con Grabación",
        subtitle: "Todo el Plan Básico más nuestro equipo va a tu negocio en Quito a grabar contenido profesional.",
        price: "$160",
        popular: false,
        features: [
          "2 artes estáticos diseñados para convertir",
          "2 videos cortos publicitarios grabados por InnovArtis",
          "1 carrusel estratégico (hasta 3 imágenes)",
          "Gestión profesional de Instagram y Facebook",
          "2 campañas activas en Meta Ads",
          "1 hora de grabación profesional en tu negocio (Quito)",
          "Copys publicitarios con enfoque en ventas",
          "Monitoreo y optimización continua 24/7",
          "Reporte mensual de resultados reales",
        ],
      },
      {
        ...
        subtitle: "Expande tu presencia a TikTok. Más contenido, más plataformas, más clientes — tú envías el material.",
        price: "$160",
        popular: false,
        features: [
          "3 artes estáticos diseñados para convertir",
          "3 videos cortos publicitarios (máx. 45 seg.)",
          "2 carruseles estratégicos (hasta 3 imágenes c/u)",
      ...
      },
      {
        ...
        subtitle: "El plan más elegido: presencia en Meta + TikTok con contenido grabado por nuestro equipo en Quito.",
        price: "$190",
        popular: true,
        features: [
          "3 artes estáticos diseñados para convertir",
          "3 videos cortos publicitarios grabados por InnovArtis",
          "2 carruseles estratégicos (hasta 3 imágenes c/u)",
          "Gestión de Instagram, Facebook y TikTok",
          "2 campañas activas en Meta Ads",
          "2 horas de grabación profesional en tu negocio (Quito)",
          "Copys publicitarios con enfoque en ventas",
          "Monitoreo y optimización continua 24/7",
          "Reporte mensual de resultados reales",
        ],
    ...
    plans: [
      {
        ...
        subtitle: "Domina Meta, TikTok y Google Maps. El combo que pone tu negocio en todos los frentes digitales.",
        price: "$230",
        popular: false,
        features: [
          "4 artes estáticos diseñados para convertir",
          "3 carruseles estratégicos",
          "4 videos cortos publicitarios",
          "3 campañas Meta Ads activas y optimizadas",
          "1 campaña TikTok Ads activa",
          "Gestión y optimización de perfil Google Maps",
          "Reporte mensual detallado con métricas reales",
          "Escalamiento inteligente de presupuesto",
          "Atención y soporte 24/7",
        ],
      },
      {
        ...
        subtitle: "Lo mismo que el Estándar pero con nuestro equipo grabando en tu negocio. Contenido profesional garantizado.",
        price: "$260",
        popular: false,
        features: [
          "4 artes estáticos diseñados para convertir",
          "3 carruseles estratégicos",
          "4 videos cortos publicitarios grabados por InnovArtis",
          "2 horas de grabación profesional en tu negocio (Quito)",
          "3 campañas Meta Ads activas y optimizadas",
          "1 campaña TikTok Ads activa",
          "Gestión y optimización de perfil Google Maps",
    ...
    plans: [
      {
        ...
        subtitle: "Para negocios que quieren escalar en serio: Meta, TikTok, Google Maps y Google Ads en un solo plan.",
        price: "$300",
        popular: false,
        features: [
          "6 artes estáticos diseñados para convertir",
          "4 carruseles estratégicos",
          "6 videos cortos publicitarios",
          "4 campañas Meta Ads activas y personalizadas",
          "2 campañas TikTok Ads activas",
      ...
      },
      {
        ...
        subtitle: "Presencia total en todas las plataformas más grabación profesional incluida. Ideal para escalar sin límites.",
        price: "$330",
        popular: false,
        features: [
          "6 artes estáticos diseñados para convertir",
          "4 carruseles estratégicos",
          "6 videos cortos publicitarios grabados por InnovArtis",
          "3 horas de grabación profesional en tu negocio (Quito)",
          "4 campañas Meta Ads activas y personalizadas",
          "2 campañas TikTok Ads activas",
          "1 campaña Google Maps o Google Ads",
          "Reporte mensual detallado con métricas reales",
    ...
    plans: [
      {
        ...
        subtitle: "Alto volumen de contenido y campañas en todas las plataformas. Para negocios que no quieren dejar de crecer.",
        price: "$390",
        popular: false,
        features: [
          "8 artes estáticos diseñados para convertir",
          "4 carruseles estratégicos",
          "8 videos cortos publicitarios",
          "5 campañas Meta Ads activas y optimizadas",
          "3 campañas TikTok Ads activas",
      ...
      },
      {
        ...
        subtitle: "El plan Plus con todo el poder de la grabación profesional incluida. Contenido y campañas al máximo nivel.",
        price: "$420",
        popular: false,
        features: [
          "8 artes estáticos diseñados para convertir",
          "4 carruseles estratégicos",
          "8 videos cortos publicitarios grabados por InnovArtis",
          "3 horas de grabación profesional en tu negocio (Quito)",
          "5 campañas Meta Ads activas y optimizadas",
          "3 campañas TikTok Ads activas",
          "2 campañas Google Maps o Google Ads",
    ...
    plans: [
      {
        ...
        subtitle: "Campañas ilimitadas en todas las plataformas con el mayor volumen de contenido. Para líderes del mercado.",
        price: "$480",
        popular: false,
        features: [
          "10 artes estáticos diseñados para convertir",
          "5 carruseles estratégicos",
          "10 videos cortos publicitarios",
          "Campañas ilimitadas en Meta Ads, TikTok Ads y Google Ads",
          "Reporte mensual detallado con métricas reales",
      ...
      },
      {
        ...
        subtitle: "Máximo contenido, máximas campañas y grabación profesional de 4 horas. El plan para dominar tu mercado.",
        price: "$510",
        popular: false,
        features: [
          "10 artes estáticos diseñados para convertir",
          "5 carruseles estratégicos",
          "10 videos cortos publicitarios grabados por InnovArtis",
          "4 horas de grabación profesional en tu negocio (Quito)",
          "Campañas ilimitadas en Meta Ads, TikTok Ads y Google Ads",
          "Reporte mensual detallado con métricas reales",
          "Escalamiento agresivo de presupuesto",
          "Atención y soporte 24/7",
    ...
    plans: [
      {
        ...
        subtitle: "El plan más completo de InnovArtis. Contenido premium, campañas ilimitadas y resultados sin techo.",
        price: "$540",
        popular: false,
        features: [
          "12 artes estáticos diseñados para convertir",
          "6 carruseles estratégicos",
      ...
      },
      {
        ...
        subtitle: "Lo máximo que InnovArtis ofrece: contenido premium, campañas sin límite y 4 horas de grabación profesional.",
        price: "$570",
        popular: false,
        features: [
          "12 artes estáticos diseñados para convertir",
          "6 carruseles estratégicos",
          "12 videos cortos publicitarios grabados por InnovArtis",
          "4 horas de grabación profesional en tu negocio (Quito)",
          "Campañas ilimitadas en Meta Ads, TikTok Ads y Google Ads",
          "Reporte mensual detallado con métricas reales",
          "Escalamiento agresivo de presupuesto",
