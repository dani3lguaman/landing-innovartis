        ...
        <Reveal>
          <div>
            ...
            <p className="text-[16px] leading-[1.85] text-white/75 mb-4">
              ...
              <strong className="text-white">conversar con ella</strong>. Este agente es una demo de lo
              que instalamos en el WhatsApp de tu negocio: responde al instante, agenda citas y ordena
              cada contacto en tu CRM.
            </p>
            <p className="text-[14px] leading-[1.8] text-white/55 italic">
              Demo guionada con respuestas de ejemplo. El agente real se configura con los precios,
              horarios y tono de tu negocio.
            </p>
          </div>
        </Reveal>
              ...
              {!started && (
                <div className="h-full flex flex-col items-center justify-center gap-4 text-center">
                  <p className="text-[14px] text-ink-soft px-6">
                    Conversa con el agente como si fueras cliente de un negocio.
                  </p>
